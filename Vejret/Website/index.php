...
<head>
	...
	Meteogram.prototype.getTitle = function () {
		return 'M̴linger fra ' + this.xml.querySelector('location name').textContent +
	...
	Meteogram.prototype.getChartOptions = function () {
		...
		return {
			...
			credits: {
				text: 'Measurements from <a href="http://akselhg.dk">akselhg.dk</a>, based on HighCharts Combo Meteogram',
	...
	$.ajax({
		dataType: 'xml',
		url: 'http://api.akselhg.dk/weather/generateXML.php',
